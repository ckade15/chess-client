...
function Footer(props) {
    ...
    if (props.type === 'mobile'){
        return (
            <footer className="bottom-0 w-full bg-transparent bg-blue-100 p-3 flex flex-col place-items-center"> 
        ...
        return (
            <footer className="bottom-0 w-full bg-transparent bg-blue-100 p-10 flex justify-evenly text-xl">
